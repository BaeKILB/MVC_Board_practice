	...
	<section id="modifyForm">
		...
		<%-- 입력받지 않은 글번호 페이지 번호를 hidden 속성으로 전달 --%>
			...
			<table>				<tr>
					...
					<td class="td_right"><input type="text" name="board_name" required="required" value="${board.board_name }"/></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="td_right"><input type="file" name="board_file"  value="${board.board_file }" required="required" /></td>
				</tr>
			</table>
